//! PyO3 bindings for `kernels::rogue`. Thin adapter: dtype-dispatch, GIL
//! release, error mapping.
//!
//! Ported from v1 `scatlas-py::stats` at V2-P1; the wilcoxon / knockoff
//! bindings were dropped together with recall.
